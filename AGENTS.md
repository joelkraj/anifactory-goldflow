...
- Scene reference attachment prioritizes visible character refs first, then location, style, UI, props, and action/effects. If a visible named character already has an approved character_state_ref, imagegen may attach it even when the prompt planner omitted it.
